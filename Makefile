...
CUR_DIR = /mnt/Jupiter/FAKS/Diplomski/3_semestar/Bioinformarika/libbloom
CFLAGS = -Wall -Wextra

INC = -I$(CUR_DIR)/murmur2

SRC = myprog.c bloom.c ./murmur2/MurmurHash2.c
...
test_prog.o : bloom.o myprog.o ./murmur2/MurmurHash2.o
				$(CC) -g $^ -o $@ -lm
